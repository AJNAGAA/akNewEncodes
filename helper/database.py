...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            thumbnail=None,
            ffmpegcode=None,
            metadata=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @WD_Topic_Group" -metadata author="@WD_Contact_Bot" -metadata:s:s title="Subtitled By :- @WD_Topic_Group" -metadata:s:a title="By :- @WD_Topic_Group" -metadata:s:v title="By:- @WD_Contact_Bot" """,
            ban_status=dict(
                is_banned=False,
                ban_duration=0,
